...
eigenface.write('classifiers/classifiersYale/classificadorEigenYale.yml')

fisherface.train(faces, ids)
fisherface.write('classifiers/classifiersYale/classificadorFisherYale.yml')

lbph.train(faces, ids)
lbph.write('classifiers/classifiersYale/classificadorLBPHYale.yml')
